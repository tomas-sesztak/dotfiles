...
local tmux = require("tomas-sesztak.plugins.tmux")
keymap.set("n", "<C-h>", function() tmux.move('h') end, { silent = true, desc = "Move Left" })
keymap.set("n", "<C-j>", function() tmux.move('j') end, { silent = true, desc = "Move Down" })
keymap.set("n", "<C-k>", function() tmux.move('k') end, { silent = true, desc = "Move Up" })
keymap.set("n", "<C-l>", function() tmux.move('l') end, { silent = true, desc = "Move Right" })
